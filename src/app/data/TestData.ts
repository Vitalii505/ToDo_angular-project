...
export class TestData {
    ...
    static tasks: Task[] = [
        {
            id: 1,
            title: 'Поменять передние рычаги',
        ...
        {
            id: 2,
            title: 'Передать отчеты начальнику отдела',
        ...
        {
            id: 3,
            title: 'Убраться у себя в квратире, полить растения',
            priority: TestData.priorities[2],
            completed: true,
        ...
        {
            id: 5,
            title: 'Найти и выучить информацыю о Socket.io',
            completed: false,
            category: TestData.categories[2]
        },
        {
            id: 6,
            title: 'Сходить на семинар по Soft Skill',
            priority: TestData.priorities[1],
            completed: true,
            category: TestData.categories[2],
        ...
        {
            id: 7,
            title: 'Найти билеты в Египет, выбрать отель',
            priority: TestData.priorities[2],
            completed: false,
        ...
        {
            id: 12,
            title: 'Сходить на лекцию "Как научиться программировать на Payton"',
            priority: TestData.priorities[1],
            completed: false,
            category: TestData.categories[2]
        },
        ...
        {
            id: 15,
            title: 'Сдать экзамен по TypeScript',
            priority: TestData.priorities[2],
            completed: true
        },
        ...
        {
            id: 16,
            title: 'Положить 35000 грн в банк на депозит',
        ...
        {
            id: 19,
            title: 'Сравнить новый айфон с стрым',
            priority: TestData.priorities[0],
            completed: false,
